...
export const LOCAL = {
  ...
  workshopExterior: `${base}/workshop/starlight-exterieur.png`,
  workshopTeam: `${base}/workshop/starlight-equipe.png`,
  workshopDevant: `${base}/workshop/Starlight_devant.png`,
